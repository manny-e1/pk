...
_s(StepUpRules, "OD7bBpZva5O2jO+Puf00hKivP7c=");
_c2 = StepUpRules;
var _c, _c1, _c2;
                                            ...
                                            },
                                            {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: flags[item.k] && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("svg", {
                                                            viewBox: "0 0 24 24",
                                                            fill: "none",
                                                            stroke: "currentColor",
                                                            strokeWidth: "3",
...
_s(RiskSimulator, "NvkyutjgUUTgGgcVoUBQJr2qUP0=");
_c = RiskSimulator;
var _c;
            ...
            async function fetchData() {
                try {
                    ...
                    if (Array.isArray(apiRules) && apiRules.length > 0) {
                        const uiRules = apiRules.map({
                            "RiskConfigPage.useEffect.fetchData.uiRules": (r)=>({
                                    id: r.id,
                                    ruleType: r.ruleType,
                                    ruleName: r.ruleName,
                                    isActive: r.isActive,
                        ...
                        }["RiskConfigPage.useEffect.fetchData.uiRules"]);
                        ...
                        const mergedRules = defaultRules.map({
                            "RiskConfigPage.useEffect.fetchData.mergedRules": (def)=>{
                                const found = uiRules.find({
                                    "RiskConfigPage.useEffect.fetchData.mergedRules.found": (r)=>r.ruleType === def.ruleType
                                }["RiskConfigPage.useEffect.fetchData.mergedRules.found"]);
                                return found ? {
                                    ...def,
                                    ...found
                                } : def;
                            }
                        }["RiskConfigPage.useEffect.fetchData.mergedRules"]);
...
_s(RiskConfigPage, "Va6r1/quEH9XO5Qcgemiklpik+c=");
_c = RiskConfigPage;
var _c;
