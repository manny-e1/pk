...
function SignupPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SignupPage.useEffect": ()=>{
            const initTelemetry = {
                "SignupPage.useEffect.initTelemetry": async ()=>{
                    try {
            ...
            }["SignupPage.useEffect.initTelemetry"];
            initTelemetry();
        }
    }["SignupPage.useEffect"], []);
    ...
    const handleSignup = async (e)=>{
        ...
        if (selectedMethod === 'password') {
            ...
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$authService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].registerPassword(formData.fullName, formData.email, formData.password, "Personal", formData.mobile, telemetry);
    ...
    const startPasskeyProcess = async ()=>{
        ...
        try {
            const telemetry = cachedTelemetry || await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$systemDevice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deviceService"].getDeviceTelemetry();
            await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$authService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].registerPasskey(formData.email, formData.fullName, formData.mobile, telemetry);
            setModalState('success');
            localStorage.setItem('paykey_last_user_email', formData.email);
        } catch (error) {
...
_s(SignupPage, "TUnajcGehtkAAEO3ZrfwKM5u/oA=", false, function() {
    return [
...
//# sourceMappingURL=_b2a2d5c4._.js.map