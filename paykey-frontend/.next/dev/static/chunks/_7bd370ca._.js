...
function WorkflowsPage() {
    ...
    const save = async ()=>{
        if (!workflowName.trim()) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"])("Workflow name is required", {
                style: {
                    color: 'red'
                }
            });
        ...
        for (const lv of levels){
            if (!lv.userIds.length) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"])("Each level needs at least one assignee", {
                    style: {
                        color: 'red'
                    }
                });
            ...
            if (lv.mode === "MULTIPLE_N_OF_M") {
                ...
                if (Number.isNaN(n) || n < 1 || n > lv.userIds.length) {
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"])("N of M must be between 1 and number of assignees", {
                        style: {
                            color: 'red'
                        }
                    });
        ...
        try {
            ...
            if (selectedWorkflowId === "new") {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"])("Workflow created");
                refetch();
            } else {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"])("Workflow saved");
                refetch();
            }
            setWorkflowName("");
            setLevels([]);
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"])(msg, {
                style: {
                    color: 'red'
                }
            });
    ...
    const deleteWf = async ()=>{
        ...
        try {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"])("Workflow deleted");
            setSelectedWorkflowId("new");
            setWorkflowName("");
            setLevels([]);
            refetch();
        } catch  {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"])("Delete failed", {
                style: {
                    color: 'red'
                }
            });
...
_s(WorkflowsPage, "5sJUA8WvICEwp5evkDCdK16plSM=", false, function() {
    return [
...
//# sourceMappingURL=_7bd370ca._.js.map