...
function useDevices(userEmail) {
    ...
    const fetchDevices = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useDevices.useCallback[fetchDevices]": async ()=>{
            try {
                ...
                const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${API_URL}/api/devices${query}`);
                const mappedData = res.data.map({
                    "useDevices.useCallback[fetchDevices].mappedData": (d)=>({
                            id: d.credentialId,
                            dbId: d.id,
                ...
                }["useDevices.useCallback[fetchDevices].mappedData"]);
    ...
    const toggleStatus = async (id, status)=>{
        await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`${API_URL}/api/devices/${id}/status`, {
            status
        });
        await fetchDevices();
    };
    const renameDevice = async (id, newName)=>{
        await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`${API_URL}/api/devices/${id}/rename`, {
            newName
        });
        await fetchDevices();
    };
...
//# sourceMappingURL=_b600d19d._.js.map