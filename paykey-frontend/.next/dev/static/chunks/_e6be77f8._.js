...
function DevicesPage() {
    ...
    const { devices, loading, refresh, actions } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useDevices$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDevices"])(paramEmail);
        ...
        "DevicesPage.useEffect": ()=>{
            if (paramEmail && devices.length > 0) {
                const foundDevice = devices.find({
                    "DevicesPage.useEffect.foundDevice": (device)=>device.email === paramEmail
...
_s(DevicesPage, "FOUEXU5fYAqha/sA9RkAFWHqrxc=", false, function() {
    return [
