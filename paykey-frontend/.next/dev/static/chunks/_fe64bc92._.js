...
function AuthLogsPage() {
    ...
    const [paymentId, setPaymentId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(searchParams.get("transactionId") || "");
    ...
    const fetchLogs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthLogsPage.useCallback[fetchLogs]": async ()=>{
            setLoading(true);
            try {
                ...
                const fltrdLogs = rawLogs.filter({
                    "AuthLogsPage.useCallback[fetchLogs].fltrdLogs": (log)=>!(log.user?.role === 'ADMIN' && (log.eventType.toLowerCase().includes("passkey") || log.eventType.toLowerCase().includes("registration") || log.eventType.toLowerCase().includes("login")))
                }["AuthLogsPage.useCallback[fetchLogs].fltrdLogs"]);
                const mappedData = fltrdLogs.map({
                    "AuthLogsPage.useCallback[fetchLogs].mappedData": (log)=>{
                        let richData = {};
                        let tagsArray = [];
                        ...
                        if (Array.isArray(richData.tags)) {
                            ...
                            tagsArray = richData.map({
                                "AuthLogsPage.useCallback[fetchLogs].mappedData": (t)=>typeof t === 'string' ? {
                                        label: t,
                                        class: 'default'
                                    } : t
                            }["AuthLogsPage.useCallback[fetchLogs].mappedData"]);
                        }
                        ...
                        return {
                            ...
                            isNewDevice: tagsArray.some({
                                "AuthLogsPage.useCallback[fetchLogs].mappedData": (t)=>t.label.toLowerCase().includes('new device')
                            }["AuthLogsPage.useCallback[fetchLogs].mappedData"]),
                            ...
                            risk: {
                                ...
                                timeline: Array.isArray(richData.timeline) ? richData.timeline.filter({
                                    "AuthLogsPage.useCallback[fetchLogs].mappedData": (s)=>typeof s === 'string' && s.trim() !== ''
                                }["AuthLogsPage.useCallback[fetchLogs].mappedData"]) : [],
    ...
    }["AuthLogsPage.useCallback[fetchLogs]"], [
        eventType
    ]);
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$admin$292f$utils$2f$riskContext$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildRiskContextTags"])({
                                                    ...
                                                    if (tag.label) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    selectedEvent.risk.stepUpRequired !== undefined && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(DetailRow, {
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            selectedEvent.risk.reasons.length ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                                className: "space-y-2 pl-2 py-1",
                                                children: selectedEvent.risk.reasons.map((r)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
...
_s(AuthLogsPage, "5pr5nXqjsO9YQvfTJeuPZfE5b2M=", false, function() {
    return [
...
__turbopack_context__.k.register(_c5, "EventIcon");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_fe64bc92._.js.map