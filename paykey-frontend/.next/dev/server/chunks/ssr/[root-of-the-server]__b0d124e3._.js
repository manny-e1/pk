...
function SignupPage() {
    ...
    const handleSignup = async (e)=>{
        ...
        if (selectedMethod === 'password') {
            ...
            setModalOpen(true);
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$authService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authService"].registerPassword(formData.fullName, formData.email, formData.password, "Personal", formData.mobile);
    ...
    const startPasskeyProcess = async ()=>{
        setModalState('loading');
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$authService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authService"].registerPasskey(formData.email, formData.fullName, formData.mobile);
            setModalState('success');
            localStorage.setItem('paykey_last_user_email', formData.email);
        } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b0d124e3._.js.map