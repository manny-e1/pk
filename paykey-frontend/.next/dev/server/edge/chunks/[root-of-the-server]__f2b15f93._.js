...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$jwt$2f$verify$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/jose/dist/webapi/jwt/verify.js [middleware-edge] (ecmascript)"); // Import jose
;
;
const authRoutes = [
    '/login',
...
const JWT_SECRET = new TextEncoder().encode(process.env.JWT_SECRET || 'kunci_rahasia_kita_bersama_123');
