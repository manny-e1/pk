        ...
        <div className="bg-[var(--bg-secondary)] border border-[var(--border-secondary)] rounded-[var(--radius-xl)] p-10 shadow-[0_4px_24px_rgba(0,0,0,0.3)]">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-xl font-semibold mb-2 text-[var(--text-primary)]">
              {verifiedUser ? 'Welcome Back ' + verifiedUser.name : 'Admin Login'}
            </h1>
            <p className="text-sm text-[var(--text-tertiary)]">
              {verifiedUser ? 'Enter your password to continue' : 'Enter your admin credentials'}
            </p>
          </div>
          ...
          {/* --- BAGIAN EMAIL / USER WIDGET --- */}
          {verifiedUser ? (
            // STATE 2: User Terverifikasi (Tautkan Email dengan Centang)
            <>
              <div className="flex items-center gap-3 p-3.5 bg-[var(--bg-tertiary)] border border-[var(--border-primary)] rounded-[var(--radius-md)] mb-3 animate-scale-in">
            ...
            // STATE 1: Input Email (Checking otomatis)
            <div className="mb-5">
              ...
              <div className="relative">
                <input
                  ...
                  onBlur={handleCheckEmail} // Trigger check saat lepas fokus
                  onKeyDown={handleEmailKeyDown} // Trigger check saat Enter
                  disabled={isChecking}
                  autoFocus
                />
          ...
          {/* --- TOMBOL PASSKEY --- */}
          {/* Logic: Disable jika user belum verified ATAU user verified tapi tidak punya passkey */}
          <button
