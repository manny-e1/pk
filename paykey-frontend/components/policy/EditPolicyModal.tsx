...
// 1. Perluas Interface sesuai HTML Template
export interface PolicyConfig {
  ...
  knownDevice: boolean;
  minDeviceAge: number;
  deviceTypes: string; // 'all' | 'platform' | 'cross-platform'
  ...
  maxAttempts: number;
  lockoutDuration: number;
  lockoutAction: string; // 'soft_lock' | 'hard_lock' | 'device_suspend' | 'account_freeze'
  captchaAfter: number;
  baseDelay: number;
  progDelay: boolean;
